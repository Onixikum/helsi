...
ActiveRecord::Schema[7.0].define(version: 2023_01_05_182718) do
  ...
  create_table "profiles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["person_type", "person_id"], name: "index_profiles_on_person"
  end
  ...
  create_table "specializations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_specializations_on_category_id"
